        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'Success!') {
              ...
              (0, _alert.showAlert)('Success', 'Logged in Successfully'); //   windows.setTimeout(()=>{
              //     // console.log("hello form location");

              location.assign("http://127.0.0.1:5000/"); //   },0)
            }
          ...
          case 8:
            ...
            //  console.log('error');
            (0, _alert.showAlert)('error', _context.t0.response.data.message); //  console.log("galat hai pagale!!");
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1Ijoic2xheWVybWQiLCJhIjoiY2s5eDZzYjhzMDhqMTNvbGk4cGc4OGZjdiJ9.RMvJPhwWQVgiTyD9DtuS_A";
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:5000/users/updateMyPassword' : 'http://127.0.0.1:5000/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
          ...
          case 4:
            ...
            if (res.data.status === 'Success!') {
              ...
              (0, _alert.showAlert)('Success', "".concat(type.toUpperCase(), " updated successfully!")); // showAlert('success', `Data updated successfully!`);
            }
...
var stripe = Stripe("pk_test_51IQENaC2RoBCLRqQ4MVfgxJcM4txL3KR7sv45FRqmwqsjTUIRogAlUVLEli8KVWdLQxg1wBv3WkNc9JJi87dKFkQ00RH2N1AA8");

var bookTour1 = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://127.0.0.1:5000/bookings/checkout-session/".concat(tourId));
  ...
  return function bookTour1(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.bookTour1 = bookTour1;
...
var reviewAdd = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, review, rating) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "POST",
              url: "http://127.0.0.1:5000/review/".concat(name),
              data: {
                review: review,
                rating: rating
              }
          ...
          case 3:
            ...
            if (res.data.status === 'Success!' || res.data.status === 'success') {
              // console.log('Logged in Successfully');
              (0, _alert.showAlert)('Success', 'Review Saved Succesfully'); //   windows.setTimeout(()=>{
              //     // console.log("hello form location");
  ...
  return function reviewAdd(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
...
//DOM elements
var mapBox = document.getElementById("map"); // console.log('index.js');

var loginForm = document.querySelector(".form--login");
var signupForm = document.querySelector(".form--signup");
var logOutBtn = document.querySelector(".nav__el--logout");
var updateDataa = document.querySelector(".form-user-data");
var updatePass = document.querySelector(".form-user-password ");
...
if (Review) {
  ...
  Review.addEventListener('submit', function (e) {
    ...
    var value = window.location.href.split('/')[5]; // value=value.split('-').join(' ');
    // console.log(value);

    (0, _review.reviewAdd)(value, review, rating);
  });
}
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    var email = document.getElementById("email").value;
    var password = document.getElementById("password").value;
    var passwordConfirm = document.getElementById("passwordConfirm").value; // console.log(name,email, password, passwordConfirm);
...
if (updatePass) {
  updatePass.addEventListener("submit", /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              passwordConfirm = document.getElementById("password-confirm").value; // console.log(name,email);
