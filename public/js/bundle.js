...
var showAlert = function showAlert(type, msg) {
  hideAlert(); // console.log("Alert showed Up!");
...
var updateData = function updateData() {
  ...
  var name = document.getElementById('form-user-data').value.name;
  var email = document.getElementById('form-user-data').value.email;
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "57694" + '/');
